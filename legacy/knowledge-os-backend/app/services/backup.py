    ...
    async def _create_qdrant_snapshot(self):
        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                response = await client.post(f"http://{qdrant_host}:{qdrant_port}/snapshots")
    ...
    async def _export_markdown(self):
        ...
        try:
            ...
            for collection in collections:
                ...
                results = await client.scroll(collection_name=collection, limit=10000, with_payload=True, with_vectors=False)
